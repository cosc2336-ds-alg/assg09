 ...
 */
TEST_CASE("AStack<int> test integer stack concrete array implementation",
          "[task0]")
{
 ...
 */
TEST_CASE("AStack<string> test string stack concrete array implementation",
          "[task0]")
{
  SECTION("test empty stack is empty")
  {
